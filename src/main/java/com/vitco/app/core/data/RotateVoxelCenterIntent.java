...
final class RotateVoxelCenterIntent extends VoxelActionIntent  {
    /**
	 * 
	 */
    ...
    protected RotateVoxelCenterIntent(VoxelData voxelData, Voxel[] voxels, int axe, float angle, boolean attach) {
        super(attach);
